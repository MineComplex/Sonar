...
public final class FallbackGravityHandler extends FallbackVerificationHandler {
  ...
  public FallbackGravityHandler(final @NotNull FallbackUser user,
    ...
    this.enableCollisionsCheck =
      !user.isGeyser() && Sonar.get().getConfig().getVerification().getGravity().isCheckCollisions();
  ...
  public void handle(final @NotNull FallbackPacket packet) {
    ...
    } else if (packet instanceof ConfirmTeleportationPacket confirmTeleport) {
